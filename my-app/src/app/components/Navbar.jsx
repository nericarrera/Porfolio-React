...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 backdrop-blur-sm bg-white/20 dark:bg-gray-900/80 border-b border-gray-200 dark:border-gray-700 shadow-sm">
                  ...
                  <div className="relative h-full flex flex-col">
                    ...
                    <div className="p-6 border-t border-white/10 bg-black/100">
                      <div className="flex justify-center space-x-6">
                        <a href="https://www.linkedin.com/in/nericarrera/" target="blank" className="text-white hover:text-sky-400 transition-colors">
                          <span className="sr-only">LinkedIn</span>
                          <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                          </svg>
                        </a>
                        <a href="https://www.github.com/nericarrera" target="blank" className="text-white hover:text-sky-400 transition-colors">
